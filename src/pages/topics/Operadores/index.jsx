  ...
  const content = (
    <>
      <p className={styles.p_container}>
        Operadores são símbolos especiais ou palavras-chave que são usados para
        realizar operações em valores, como cálculos matemáticos, comparações e
        atribuições.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores aritméticos são utilizados para realizar operações
        matemáticas em JavaScript, eles permitem que você realize cálculos com
        números e obtenha resultados numéricos.
      </p>

      <p className={styles.p_container}>
        Além dos operadores de adição (+), subtração (-), multiplicação (*) e
        divisão (/), que são bem conhecidos, ainda temos o operador de módulo
        (%) que retorna o resto da divisão e o operador de exponenciação (**)
        que retorna a base elevado ao expoente.
      </p>

      <Code codeString={operadores["01"]} />

      <p className={styles.p_container}>
        Os operadores aritméticos têm uma ordem de precedência, o que determina
        a ordem em que eles são avaliados quando uma expressão contém múltiplos
        operadores, para definirmos uma ordem específica de precedência, a
        expressão deve estar entre parênteses.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores de Atribuição são utilizados para atribuir valores a
        variáveis. Já vimos sobre o operador de atribuição (=) que atribui um
        valor a uma variável, agora vamos ver alguns exemplos de outros
        operadores de atribuição.
      </p>
      ...
      <p className={styles.p_container}>
        Ainda existem outros operadores de atribuição mas como não são comumente
      ...
      <p className={styles.p_container}>
        Operadores de Comparação são utilizados para comparar valores e
        expressões, geralmente retornando um valor booleano (true ou false) que
        indica se a comparação é verdadeira ou falsa. Eles são fundamentais para
        controlar o fluxo de um programa e tomar decisões lógicas.
      </p>

      <Code codeString={operadores["04"]} />

      <p className={styles.p_container}>
        Preste atenção na diferença entre igualdade (==) e igualdade estrita
        (===), a igualdade verifica apenas o valor dos operandos, por isso na
        linha 6, 10 (number) é igual a &apos;10&apos; (string) e a igualdade
        estrita verifica o valor e o tipo dos operandos, por isso na linha 9, a
        mesma comparação é avaliada como false.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores Lógicos são utilizados para realizar operações de lógica
        booleana retornando true ou false.
      </p>
      ...
      <p className={styles.p_container}>
        O ! (NÃO Lógico) inverte o valor booleando, de true para false ou de
        false para true.
      </p>

      <p className={styles.p_container}>
        O ?? (Nullish coalescing) retorna o seu operando do lado direito quando
        o seu operador do lado esquerdo é null ou undefined, caso contrário, ele
        retorna o seu operando do lado esquerdo.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores de Incremento e Decremento são utilizados para incrementar 1
        a uma variável (<span className={styles.code}>++</span>) ou
        decrementar 1 a uma variável (
        <span className={styles.code}>--</span>). Podem ser
        pré-incremento / pré-decremento quando o operador vem antes da variável
        ou pós-incremento / pós-decremento quando o operador vem depois da
        variável.
      </p>
      ...
      <p className={styles.p_container}>
        Operador de Concatenação é utilizado para concatenar (juntar) duas ou
        mais strings, resultando em uma única string.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores de Bitwise são utilizados para realizar operações de
        manipulação de bits em números inteiros. Eles tratam números como
        sequências de bits e executam várias operações bit a bit.
      </p>

      <Alerta message="Os operadores de bitwise quase nunca são utilizados, portanto não invistam muito tempo para entendê-los, só estamos exibindo aqui para que você saiba que eles existem." />

      <p className={styles.p_container}>
        Os números inteiros são convertidos em binário (sequência de 0 e 1),
        esses binários são colocados um embaixo do outro e é aplicado a lógica
        booleana da última coluna para a primeira coluna, convertendo o 0 para
        false e o 1 para true.
      </p>
      ...
      <p className={styles.p_container}>
        Operador Ternário é utilizado para retornar um ou outro valor dependendo
        se a avaliação de uma estrutura condicional retorna true ou false.
      </p>
      ...
      <p className={styles.p_container}>
        Operadores de Acesso a Propriedades são utilizados para acessar as
        propriedades de objetos, o Optional Chaining é uma forma mais segura de
        acesso porque antes de acessar a propriedade ele verifica se ela existe.
      </p>
      ...
      <p className={styles.p_container}>
        Operador de Vírgula é utilizado para combinar várias expressões em uma
        única instrução. Ele avalia cada expressão da esquerda para a direita e
      ...
      <p className={styles.p_container}>
        O operador typeof é utilizado para obter o tipo de dado de uma
        expressão. Ele retorna uma string que indica o tipo de dado.
      </p>

      <p className={styles.p_container}>
        O operador instanceof é utilizado para verificar se um objeto é uma
        instância de uma classe ou construtor específico. Ele retorna true se o
        objeto for uma instância da classe, caso contrário, retorna false.
      </p>

      <p className={styles.p_container}>
        O operador delete é utilizado para remover uma propriedade de um objeto.
        Ele retorna true se a propriedade for removida com sucesso, caso
        contrário, retorna false. Também pode ser utilizado para remover
        elementos de um array. O operador delete remove o elemento, mas deixa o
        valor undefined no array.
      </p>

      <Code codeString={operadores["12"]} />

      <Alerta message="Note que na linha 4, typeof null retorna object. O operador delete é considerado por muitos uma má prática, existem formas melhores e mais performáticas de remover propriedades de objetos e elementos de array. Não use o operador delete." />
    </>
  );
